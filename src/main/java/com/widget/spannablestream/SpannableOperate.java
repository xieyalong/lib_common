package com.widget.spannablestream;
...
import com.widget.spannablestream.click.ClickableSpanWrapper;
import com.widget.spannablestream.color.ColorConfig;
import com.widget.spannablestream.interfacer.IClickable;
import com.widget.spannablestream.interfacer.ISpanOperate;
...
//                int color = ContextCompat.getColor(context, colorRes);
                return new ForegroundColorSpan(context.getResources().getColor(colorRes));
            }
        };
    }
    ...
    public SpannableOperate bgColorRes(@ColorRes final int colorRes) {
        return new SpannableOperate(this) {
            @Override
            public Object getCurrentSpan() {
                return new BackgroundColorSpan(context.getResources().getColor(colorRes));
            }
        };
    }
