package com.widget.tilibrary.transfer;
...
import com.widget.tilibrary.loader.UniversalImageLoader;
import com.widget.tilibrary.style.index.CircleIndexIndicator;
import com.widget.tilibrary.style.progress.ProgressBarIndicator;
import com.widget.tilibrary.loader.ImageLoader;
...
public class Transferee implements DialogInterface.OnShowListener,
    ...
    private void checkConfig() {
        ...
        transConfig.setImageLoader(transConfig.getImageLoader() == null
                ? (ImageLoader) UniversalImageLoader.with(context.getApplicationContext())
